...
import { Users, UserCog, Settings, Key, FileText } from 'lucide-react';
import AdminUsers from '../components/admin/AdminUsers';
import AdminTeams from '../components/admin/AdminTeams';
import AdminOIDCProviders from '../components/admin/AdminOIDCProviders';
import AdminSettings from '../components/admin/AdminSettings';

type Tab = 'users' | 'teams' | 'oidc' | 'settings' | 'api-docs';
...
export default function Admin() {
  ...
  const tabs = [
    ...
    { id: 'api-docs' as Tab, label: t('apiDocs.title'), icon: FileText, external: true },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mt-6">
        ...
        {activeTab === 'api-docs' && (
          <div className="h-[calc(100vh-300px)] rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            <iframe
              src="/api-docs"
